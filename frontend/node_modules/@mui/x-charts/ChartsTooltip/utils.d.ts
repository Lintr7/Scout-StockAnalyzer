import { AxisInteractionData, ItemInteractionData } from '@mui/x-charts/context/InteractionProvider';
import { ChartSeriesType } from '@mui/x-charts/models/seriesType/config';
type MousePosition = {
    x: number;
    y: number;
