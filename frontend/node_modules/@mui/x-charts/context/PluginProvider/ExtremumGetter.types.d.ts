import type { CartesianChartSeriesType, ChartSeries, ChartSeriesType } from '@mui/x-charts/models/seriesType/config';
import type { AxisConfig, AxisId } from '@mui/x-charts/models/axis';
import type { SeriesId } from '@mui/x-charts/models/seriesType/common';
